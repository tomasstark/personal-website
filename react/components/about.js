                    ...
                    <section className="static-page animated slideInUp">
                        <div className="container">
                            <section className="static-page__section">
                                ...
                                <p>Having worked with UX teams very closely, I have strong attention to detail and I’m always doing my best to provide the most amazing experience for every product I make.</p>

                                <p>I’m currently WordPress Engineer at <a href="http://thethemefoundry.com"
                                target="_blank">The Theme Foundry</a>, working hard and shipping new features for <a href="https://thethemefoundry.com/wordpress-themes/make/" target="
                                _blank ">Make</a> and <a href="https://wordpress.org/plugins/happyforms/" target="_blank">HappyForms</a>.</p>

                                <p>Feel free to <Link to="/contact">get in touch</Link> if any of the above interests you in any way :)</p>
                            </section>
                        </div>
                    </section>
                </main>
