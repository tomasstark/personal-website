                    ...
                    <section className="static-page animated slideInUp">
                        <div className="container">
                            <section className="static-page__section">
                                ...
                                <p>I’m currently WordPress Engineer at <a href="http://thethemefoundry.com" target="_blank">The Theme Foundry</a>, shipping new features for <a href="https://thethemefoundry.com/wordpress-themes/make/" target="_blank">Make</a>.</p>
